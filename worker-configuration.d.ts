/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9b25611b55312271b27f33198b9bf4df)
// Runtime types generated with workerd@1.20260908.1 2026-03-22 nodejs_compat
interface __BaseEnv_Env {
	BUCKET: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	WORLDS: DurableObjectNamespace<import("./src/worker").WorldDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "WorldDO";
	}
